...
interface ZynoBottomNavProps {
  activeTab: 'home' | 'chats' | 'search' | 'profile' | 'settings';
  onTabChange: (tab: 'home' | 'chats' | 'search' | 'profile' | 'settings') => void;
}
        ...
        return (
          <button
            ...
            className={cn(
              ...
              isActive ? "text-plum-700 scale-110" : "text-gray-400 hover:text-gray-600"
            )}
          >
            <div className={cn(
              "p-1.5 rounded-xl transition-colors",
              isActive ? "bg-plum-50" : "bg-transparent"
            )}>
