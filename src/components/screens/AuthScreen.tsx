      ...
      <div className="p-8 flex-1 flex flex-col justify-center space-y-12">
        ...
        <div className="flex flex-col items-center text-center space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs font-bold text-gray-400 uppercase tracking-[0.3em]">Next-Gen Messaging</p>
          </div>
        </div>
                ...
                <div className="flex justify-between gap-2">
                  {otp.map((digit, i) => (
                    <input
                      ...
                      className="w-12 h-16 bg-gray-100 border-none rounded-2xl text-center text-2xl font-black text-charcoal focus:ring-4 focus:ring-plum-500/20 focus:bg-white transition-all shadow-inner"
                    />
                  ))}
                </div>

                <button 
                  onClick={onSignIn} // Mocking successful OTP with Google Sign-in for now
              ...
              >
                ...
                <div className="relative py-4">
                  ...
                  <div className="relative flex justify-center">
                    <span className="bg-white px-4 text-[10px] font-black text-gray-300 uppercase tracking-widest">Or continue with</span>
                  </div>
                </div>
                ...
                <button 
                  type="button"
                  onClick={onSignIn}
                  className="w-full bg-white border-2 border-gray-100 text-charcoal py-5 rounded-3xl font-black uppercase tracking-widest shadow-sm flex items-center justify-center gap-3 hover:bg-gray-50 hover:border-gray-200 transition-all"
                >
