...
const ZynoHeader: React.FC<ZynoHeaderProps> = ({ user, onProfileClick }) => {
  return (
    <header className="h-16 bg-plum-700 text-white flex items-center justify-between px-4 shadow-lg z-50">
      ...
      <div className="flex items-center gap-3">
        <button className="p-2 hover:bg-white/10 rounded-full transition-colors relative">
          ...
          <span className="absolute top-1.5 right-1.5 w-2 h-2 bg-red-500 rounded-full border-2 border-plum-700"></span>
        </button>
        <button 
